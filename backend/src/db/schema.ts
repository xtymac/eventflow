import { pgTable, varchar, text, timestamp, integer, index, primaryKey, customType, AnyPgColumn } from 'drizzle-orm/pg-core';
...
export const roadAssets = pgTable('road_assets', {
  ...
  replacedBy: varchar('replaced_by', { length: 50 }).references((): AnyPgColumn => roadAssets.id),
