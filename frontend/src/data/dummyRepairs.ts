...
export const DUMMY_REPAIRS: DummyRepair[] = [
  ...
  { id: 'REP-013', facilityId: 'PF-demo-007', date: '2025-07-03', type: '塗装', description: 'シェルター防錆塗装', status: '完了', caseId: 'EVT-demo-019' },
  ...
  { id: 'REP-023', facilityId: 'PF-demo-012', date: '2024-11-15', type: '塗装', description: 'ベンチ脚部の防錆塗装', status: '完了', caseId: 'EVT-demo-020' },
  ...
  { id: 'REP-052', facilityId: 'PF-demo-022', date: '2024-06-10', type: '塗装', description: 'すべり台の防錆塗装', status: '完了', caseId: 'EVT-demo-021' },
  ...
  { id: 'REP-061', facilityId: 'PF-demo-028', date: '2025-06-10', type: '溶接補修', description: '鉄棒の溶接補修', status: '完了', caseId: 'EVT-demo-022' },
  ...
  { id: 'REP-072', facilityId: 'PF-demo-052', date: '2025-02-10', type: '安全対策', description: '複合遊具の転落防止柵設置', status: '完了', caseId: 'EVT-demo-017' },
  ...
  { id: 'REP-091', facilityId: 'PF-demo-035', date: '2025-10-10', type: '部材交換', description: 'ベンチ座面の木材交換（5基）', status: '完了', caseId: 'EVT-demo-023' },
];
